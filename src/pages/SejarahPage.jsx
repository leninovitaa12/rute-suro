      ...
      <section className="content-section">
        <div className="container">
          ...
          <div className="nilai-section">
            <h2 className="section-title">Visi Masa Depan</h2>
            
            <div className="nilai-grid">
              <div className="nilai-card">
                <div className="nilai-number">01</div>
                <h3 className="nilai-title">Pelestarian Warisan</h3>
                <p className="nilai-description">
                  Memastikan tradisi Grebeg Suro tetap lestari dan relevan bagi generasi 
                  mendatang dengan melibatkan pemuda dalam setiap prosesi dan kegiatan.
                </p>
              </div>

              <div className="nilai-card">
                <div className="nilai-number">02</div>
                <h3 className="nilai-title">Integrasi Teknologi</h3>
                <p className="nilai-description">
                  Mengadopsi teknologi modern seperti sistem navigasi cerdas untuk 
                  meningkatkan pengalaman pengunjung tanpa mengurangi nilai sakral tradisi.
                </p>
              </div>

              <div className="nilai-card">
                <div className="nilai-number">03</div>
                <h3 className="nilai-title">Promosi Pariwisata</h3>
                <p className="nilai-description">
                  Menjadikan Grebeg Suro sebagai destinasi wisata budaya unggulan yang 
                  dapat menarik wisatawan domestik dan mancanegara.
                </p>
              </div>

              <div className="nilai-card">
                <div className="nilai-number">04</div>
                <h3 className="nilai-title">Pemberdayaan Ekonomi</h3>
                <p className="nilai-description">
                  Memberdayakan UMKM lokal dan pelaku seni untuk berkembang melalui 
                  momentum acara yang dihadiri ribuan pengunjung setiap tahunnya.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="quote-section">
            <div className="quote-card">
              ...
              <p className="quote-author">— Tokoh Budaya Ponorogo</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="cta-section">
        <div className="container">
          <div className="cta-box">
            ...
            <a href="/jadwal" className="btn-primary">
              📅 Lihat Jadwal Event
            </a>
          </div>
        </div>
